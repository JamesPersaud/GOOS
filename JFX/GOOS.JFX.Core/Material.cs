...
namespace GOOS.JFX.Core
{
    public class Material
    {
		...
		{
			DrawQuadWithMaterial(quad, ref world, false);
		}
        public void DrawQuadWithMaterial(Quad quad, ref Matrix world, bool selfshadow)
        {
            //if (quad == null)
            //{
            ...
            //set the world parameter of this instance of the model
            effectInstance.Parameters["world"].SetValue(world);
			effectInstance.Parameters["wallSelfShadow"].SetValue(selfshadow);
