...
namespace GOOS.JFX.Level
{
	/// <summary>
	/// 
	/// This class is taken from Mike Gold's blog http://www.gamespp.com/c/generatingMazes.html
	/// 
	/// And modified.
	/// 
	/// 
	/// TODO: Remove limitation of square mazes!!!!
	/// 
	/// 
	...
	public class Maze
	{
		...
		{
			kDimension = Dimention;
			TotalCells = Dimention * Dimention;
			Initialize();
		}
